...
import { SearchOutlined, SettingOutlined, BellOutlined, StarOutlined, PlusOutlined, EllipsisOutlined, AppstoreOutlined, UnorderedListOutlined, ScheduleOutlined, FolderOutlined, GroupOutlined, MenuOutlined, StarFilled, BellFilled } from '@ant-design/icons';
                ...
                <div className="flex-1 ml-3">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            {task.reminder ? (
                                <BellFilled className="text-blue-400!" />
                            ) : (
